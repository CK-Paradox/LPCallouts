            ...
            if (Rage.Game.IsKeyDown(GameHandler.ini_action))
            {
                ...
                switch (_mlog_loop1)
                {
                    ...
                    case 4:
                        ...
                        if (_cplus_active)
                        {
                            CPlusFunctions.AddUpdateToCallout(_callout_id, "Contact with officer on scene. One Victim with serious injuries, Two possible Witnesses, possible hit and run.");
                            CPlusFunctions.AddUpdateToCallout(_callout_id, "Following up with questioning witness");
                        }
                        _mlog_loop1 = 5;
                        break;
                    case 5:
            ...
            if (Rage.Game.IsKeyDown(GameHandler.ini_action))
            {
                ...
                switch (_mlog_loop2)
                {
                    ...
                    case 5:
                        ...
                        if (_cplus_active)
                        {
                            Persona _witness1 = Functions.GetPersonaForPed(_ped_civ1);
                            CPlusFunctions.AddUpdateToCallout(_callout_id, "First Witness Name: " + _witness1.FullName + ", Vehicle: " + _veh_civ1.Model.Name + ", Licence Plate: " + _veh_civ1.LicensePlate);
                            CPlusFunctions.AddUpdateToCallout(_callout_id, "No information available from first witness. Stopped for first aid");
                        }
                        _mlog_loop2 = 6;
                        break;
                    case 6:
            ...
            if (Rage.Game.IsKeyDown(GameHandler.ini_action))
            {
                ...
                switch (_mlog_loop3)
                {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        GameHandler.PlayerChat(3, "A ~y~" + _veh_suspect.Model.Name + Dialog);
                        _mlog_loop3 = 4;
                        break;
                    case 4:
                        GameHandler.PlayerChat(1, "Did you see the ~y~" + _veh_suspect.Model.Name + "~w~'s license plate?");
                        _mlog_loop3 = 5;
                        break;
                    case 5:
                        GameHandler.PlayerChat(3, "Yes I did. It was ~y~" + _veh_suspect.LicensePlate);
                        _mlog_loop3 = 6;
                        switch (endingvariant)
                        {
                            case Globals.CalloutEnd.NORMAL:
                                SuspectHandler.GetLocation(_callout_id, _cplus_active, _veh_suspect.Model.Name, _veh_suspect.LicensePlate, _veh_suspect, _ped_suspect, _ped_civ1, _blip_suspect, _suspect_location._ped_position, SuspectData.FullName);
                                break;
                            case Globals.CalloutEnd.ABANDON:
                            case Globals.CalloutEnd.TRAFFICSTOP:
                                SuspectHandler.GetLocation(_callout_id, _cplus_active, _veh_suspect.Model.Name, _veh_suspect.LicensePlate, _veh_suspect, _ped_civ1);
                                break;
                        }
                        break;
                    case 6:
