            ...
            if (Rage.Game.IsKeyDown(GameHandler.ini_action))
            {
                ...
                switch (_mlog_loop1)
                {
                    ...
                    case 3:
                        ...
                        if (_cplus_active)
                        {
                            CPlusFunctions.AddUpdateToCallout(_callout_id, "Contact with officer on scene. One Victim, One Witness, possible hit and run.");
            ...
            if (Rage.Game.IsKeyDown(GameHandler.ini_action))
            {
                ...
                switch (_mlog_loop2)
                {
                    case 0:
                        ...
                        break;
                    case 1:
                        GameHandler.PlayerChat(4, Dialog);
                        _mlog_loop2 = 2;
                        break;
                    case 2:
                        GameHandler.PlayerChat(6, Dialog);
                        _mlog_loop2 = 3;
                        break;
                    case 3:
                        GameHandler.PlayerChat(1, Dialog);
                    ...
                    case 5:
                        ...
                        if (_cplus_active)
                        {
                            Persona _victim = Functions.GetPersonaForPed(_ped_victim);
                            CPlusFunctions.AddUpdateToCallout(_callout_id, "Victim Name: " + _victim.FullName + ", Vehicle: " + _veh_victim.Model.Name + ", Licence Plate: " + _veh_victim.LicensePlate);
                            CPlusFunctions.AddUpdateToCallout(_callout_id, "Accident is Hit and Run, no information available from victim due to a trauma.");
                        }
                        _mlog_loop2 = 6;
                        break;
                    case 6:
            ...
            if (Rage.Game.IsKeyDown(GameHandler.ini_action))
            {
                ...
                switch (_mlog_loop3)
                {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        GameHandler.PlayerChat(3, "I think it was a ~y~ " + _veh_suspect.Model.Name + " ~w~" + Dialog);
                        _mlog_loop3 = 4;
                        break;
                    case 4:
                        GameHandler.PlayerChat(1, Dialog + " ~y~" + _veh_suspect.Model.Name);
                        _mlog_loop3 = 5;
                        break;
                    case 5:
                        GameHandler.PlayerChat(3, Dialog + " ~y~" + _veh_suspect.LicensePlate);
                        _mlog_loop3 = 6;
                        switch (endingvariant)
                        {
                            case Globals.CalloutEnd.NORMAL:
